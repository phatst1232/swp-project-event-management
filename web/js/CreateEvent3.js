...
//     $(this).addClass("tbnactive");
//   } else {


//     $(this).removeClass("tbnactive");
...
// });
$(".tblbtn").click(function () {
    if ($(this).hasClass('tbnactive')) {
      $(this).removeClass("tbnactive");
      $(this).addClass("default");
    }else if($(this).hasClass('inactive')){
      alert("This room is already in used");
    ...
    var methods = {
        init: function(options) {
            ...
            select = $(
                ...
                '      <button type="button" style="background-color: black" onclick="deselectAll(' + selectId + ')"></button>' +
                '   </div>' +
