...
<html lang="en">
    ...
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="./css/PersonalProfile2.css" />
        ...
        <body>
            ...
            <div class="sidebar">
                <div class="logo-content">
                    <div class="logo">
                        <img src="image\243476569_4979393015418472_7594668457206850499_n.png" width="60px"
                             height="60px">
                ...
                <ul class="nav-list">
                    <li>
                        <form action="MainController" name="Search Bar">
                            ...
                            <input type="text" name="search" id="name" value="<%=search%>"
                                   placeholder="Search...">
                    ...
                    <% if (loginUser != null) { %>
                    <li class="active tab">
                        <a href="PersonalProfile.jsp" id="defaultOpen" class="tablink"
                           onclick="opentab('tabpro', this)">
                            <i id="Profile-search"><img src="image/icons8-user-24.png"
                                                        style="width: 30px; height: 30px;"></i>
                            <span class="link-name">Profile</span>
                        </a>
                        <span class="label tooltip">Profile</span>
                    </li>

                    <li class="active tab">
                        <a class="tablink" onclick="opentab('tabcon', this)">
                            <i id="Account-search"><img src="image/edit.png"
                                                        style="width: 30px; height: 30px;"></i>
                            <span class="link-name">Edit Profile</span>
                        </a>
                        <span class="label tooltip">Edit Profile</span>
                    </li>
                    ...
                    <li>
                        <a href="adminPage.jsp">
                            <i id="user-search"><img src="image/favourite.png"
                                                     style="width: 24px; height: 24px;"></i>
...
<!--                    <li>
                    ...
                    <div class=" containerbox">
                        <div id="tabcon" class=" accountcontent tabcontent">
                            ...
                            <form action="MainController" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="accfieldrow">
                                        <div class="accfieldbox">
                                            <label for="">Avatar</label> <input type="file"
                                                                                onchange="readURL(this)" name="avtLink">
                                ...
                                <button type="submit" class="accsubmitbtn" name="action"
                                        value="userpr5">SAVE</button>
                            </form>
                        ...
                        <div id="tabpro" class=" profilecontent tabcontent">
                            ...
                            <div class="profile fields"><span>Role</span>
                                <div class="profile value">
                                    <%=dao.getRoleName(loginUser.getRoleID())%>
                                </div>
                            </div>
            ...
            <script>
                ...
                document.getElementById('tabac').style.display = "none";
