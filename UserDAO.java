...
public class UserDAO {
    ...
    public UserDTO checkLogin(String userID, String password) throws SQLException {
        ...
        try {
            conn = DBUtils.getConnection();
            String sql = " SELECT userName, roleID,address,phonenumber,interestedDetail FROM tblUsers "
            ...
            if (rs.next()) {
                ...
                String interestedDetail = rs.getString("interestedDetail");
                user = new UserDTO(userID, userName, password, roleID, address, phone, interestedDetail);
            }
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
        ...
        try {
            ...
            if (conn != null) {
                String sql = " UPDATE tblUsers "
                        + " SET userName=?, Password=?, address=?, phoneNumber=?,interestedDetail=?"
                        + " WHERE userID=?";
                stm = conn.prepareStatement(sql);
                ...
                stm.setString(5, user.getInterestedDetail());
